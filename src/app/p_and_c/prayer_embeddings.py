...
class PrayerRelation():
    ...
    async def _load_prayer_feedback(self, key='prayer_details') -> Dict:
        ...
        try:
            ...
            return data.get(key, {}), "prayer"
        except ClientError as e:
            logger.error(f"Failed to load prayer feedback from S3: {str(e)}")
            return "Sorry, something went wrong, couldnt't access json file in s3", "normal"
